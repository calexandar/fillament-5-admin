        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group">
                ...
                <h3 class="mt-4 text-lg font-medium">
                    {{ $service === 1 ? 'Interior Design' : ($service === 2 ? 'Space Planning' : ($service === 3 ? 'Renovation' : 'Consultation')) }}
                </h3>

                <p class="text-neutral-400 text-sm">
                    {{ $service === 1 ? 'Thoughtfully crafted interiors.' : ($service === 2 ? 'Optimizing layouts for functionality.' : ($service === 3 ? 'Transforming existing spaces with modern solutions.' : 'Professional advice for your vision.')) }}
                </p>
